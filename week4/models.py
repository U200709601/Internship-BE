...
class LicensedOperator(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("operator_LicensedOperator_detail", args=(self.pk,))

    def get_update_url(self):
        return reverse("operator_LicensedOperator_update", args=(self.pk,))
